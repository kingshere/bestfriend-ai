  ...
  return (
    <>
      <div className="bg-gradient-to-r from-emerald-900 via-teal-800 to-blue-900 min-h-screen p-6 flex flex-col items-center text-white">
        {/* Fixed header banner - reduced size */}
        <div className="fixed top-0 left-0 right-0 z-10 bg-gradient-to-r from-emerald-900 via-teal-800 to-blue-900 py-2 shadow-lg">
        ...
        {/* Reduced padding to account for smaller fixed header */}
